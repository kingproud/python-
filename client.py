...
from sm4 import Sm4
from fast_mod_dh import  fast_mod_DH
    ...
    def login(self, event):
        ...
        try:
            ...
            if response == b'UserName Empty':
                ...
                self.Close()
                ChatFrame(None, 2, title='Chat', size=(500, 400))
        except Exception:
...
class ChatFrame(wx.Frame):
    ...
    def __init__(self, parent, id, title, size):
        ...
        self.Center()
        self.chatFrame = wx.TextCtrl(self, pos=(5, 5), size=(600, 310), style=wx.TE_MULTILINE | wx.TE_READONLY)
